...
class Guard implements HttpKernelInterface {
     ...
     */
    public function __construct(HttpKernelInterface $app, Encrypter $encrypter, Repository $config)
    {
        $this->app = $app;
    ...
    protected function encrypt(Response $response)
    {
        ...
        {
            if ($this->shouldBeEncrypted($c->getName())) {
    ...
    {
        return !isset($this->config['cookies']['skip_encryption'])
            || !in_array($key, $this->config['cookies']['skip_encryption']);
    }
